...
if ( $tm_setting_background_section_hero ) : ?>
    ...
    <div id="section-hero" class="parallax-window section-home full-height" data-parallax="scroll" data-image-src="<?php echo esc_url( $tm_setting_background_section_hero ); ?>">

        <div class="overlay"></div><!-- /.overlay -->

<?php else : ?>

    <div id="section-hero" class="section-home full-height default-bg-color">
