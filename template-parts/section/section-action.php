...
<?php if ( $tm_use_section_action ) : ?>

    <?php $tm_title_section_action = get_theme_mod( 'tm_title_section_action' ); ?>
    <?php $tm_description_section_action = get_theme_mod( 'tm_description_section_action' ); ?>
